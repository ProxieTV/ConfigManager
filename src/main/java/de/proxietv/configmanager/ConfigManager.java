...
import de.proxietv.configmanager.ConfigManager.MultiKey.MultiKeyEntry;
import de.proxietv.configmanager.ConfigManager.MultiKey.MultiKeyMap;
...
public class ConfigManager {
    ...
    public static void saveRecourceFile(Class someClass, String name, String path, boolean replace){
        File file = new File(path, name);
        File filepath = new File(path);
        if (replace && file.exists()){
            file.delete();
            saveRecource(someClass, name, path);
        } else {
            filepath.mkdirs();
            saveRecource(someClass, name, path);
        }
    ...
    private static void saveRecource(Class someClass, String name, String path){

        try {
            InputStream inStream = someClass.getResourceAsStream("/" + name);
